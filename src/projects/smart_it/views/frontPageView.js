...
const PROJECT = {
    title: 'Smart IT',
    subtitle: 'Plateforme intelligente pour les workflows d’imagerie médicale',
    description: 'Automatiser, organiser et analyser les données médicales avec des outils intelligents.',
    logo: '/project-logos/smart_it.png',
    mainTool: 'Automatisation intelligente',
    secondTool: 'Analyse de données',
